    ...
    <div>
      <nav className="navbar navbar-expand-lg navbar-dark bg-primary bg-gradient">
        <div className="container-fluid">
          <NavLink className="navbar-brand text-uppercase" to="/">My App</NavLink>
          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <form className="d-flex">
              ...
              {state ? <button onClick={(event) => logout(event)} className="btn btn-danger" type="submit">
                ...
                : <>
                  <NavLink to='/login' className="btn btn-primary" type="submit">
                    <i className="fa-solid fa-right-to-bracket"></i>
                  </NavLink>
                  <NavLink to='/signup' className="btn btn-primary" type="submit">
